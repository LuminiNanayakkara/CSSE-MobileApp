...
const Home = ({navigation}) => {
  ...
  const bookOtherWordsForHome = {
    ...
    bookCover: images.one,
    rating: 4.5,
    language: 'Eng',
    pageNo: 341,
    author: 'House For Sale',
  ...
  const bookTheMetropolis = {
    ...
    bookCover: images.two,
    rating: 4.1,
    language: 'Eng',
    pageNo: 272,
    author: 'Land Sale In Malabe',
  ...
  const bookTheTinyDragon = {
    ...
    bookCover: images.three,
    rating: 3.5,
    language: 'Eng',
    pageNo: 110,
    author: 'House Sale In Avissawella',
      ...
      <View
        ...
        <View style={{flex: 1}}>
          <View style={{marginRight: SIZES.padding}}>
            ...
            <Text style={{...FONTS.h2, color: COLORS.black}}>User</Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate('PropertyAddForm')
            console.log('Point');
          }}>
          <View
            style={{
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <Text style={{...FONTS.h2, color: COLORS.darkBlue}}>Premium Listings</Text>
