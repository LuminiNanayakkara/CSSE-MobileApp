        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ ...FONTS.h2 }}>House Sale in Malabe</Text>
                    <Text style={{ ...FONTS.h3 }}>Price : Rs.250000/=</Text>
                    <Text style={{ ...FONTS.h3 }}>Location : Malabe</Text>
                ...
                >
                    ...
                    >
                        <Text style={{ color: COLORS.white, ...FONTS.h3 }}>Contact Seller</Text>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
